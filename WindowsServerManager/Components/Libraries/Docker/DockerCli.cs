...
namespace WindowsServerManager.Components.Libraries.Docker
{
    public class DockerCli : IDisposable
    {
        ...
        {
            List<DockerStat> containersFound = new List<DockerStat>(); // Converting to [] breaks execution do not modify
